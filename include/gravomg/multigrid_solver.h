...
namespace GravoMG {
    ...
    public:
        ...
        double inTriangle(const Eigen::RowVector3d &p, const std::vector<int> &tri, const Eigen::RowVector3d &triNormal,
        ...
        std::vector<double> inverseDistanceWeights(const Eigen::MatrixXd &pos, const Eigen::RowVector3d &source,
        ...
        double multiGridVCycleGS(Eigen::SparseMatrix<double> &A, Eigen::MatrixXd &b, Eigen::MatrixXd &x, int k,
                                 bool isDebug = true);

        double multiGridFCycleGS(Eigen::SparseMatrix<double> &A, Eigen::MatrixXd &b, Eigen::MatrixXd &x, int k,
                                 bool isDebug = true);

        double multiGridWCycleGS(Eigen::SparseMatrix<double> &A, Eigen::MatrixXd &b, Eigen::MatrixXd &x, int k,
                                 bool isDebug = true);
        ...
        double residualCheck(const Eigen::SparseMatrix<double> &A, const Eigen::MatrixXd &b, const Eigen::MatrixXd &x,
                             int type);
